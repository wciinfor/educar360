...
DROP POLICY IF EXISTS "Tenant staff can INSERT students" ON public.students;
...
DROP POLICY IF EXISTS "Tenant staff can UPDATE students" ON public.students;
...
DROP POLICY IF EXISTS "Tenant staff can DELETE students" ON public.students;
...
DROP POLICY IF EXISTS "Tenant isolation for guardians SELECT" ON public.guardians;
...
DROP POLICY IF EXISTS "Tenant staff can INSERT guardians" ON public.guardians;
...
DROP POLICY IF EXISTS "Tenant staff can UPDATE guardians" ON public.guardians;
...
DROP POLICY IF EXISTS "Tenant staff can DELETE guardians" ON public.guardians;
...
DROP POLICY IF EXISTS "Tenant isolation for student_guardians SELECT" ON public.student_guardians;
...
DROP POLICY IF EXISTS "Tenant staff can INSERT student_guardians" ON public.student_guardians;
...
DROP POLICY IF EXISTS "Tenant staff can UPDATE student_guardians" ON public.student_guardians;
...
DROP POLICY IF EXISTS "Tenant staff can DELETE student_guardians" ON public.student_guardians;
