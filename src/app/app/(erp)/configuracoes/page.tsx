    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900">Configurações da Instituição</h1>
            <p className="text-sm text-slate-500">Parâmetros gerais, identidade visual e dados cadastrais da escola.</p>
          </div>
        </div>
