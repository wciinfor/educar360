    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-zinc-900">Faturamento da Plataforma</h1>
            <p className="text-sm text-zinc-500">Cobrança de mensalidades dos clientes SaaS, faturamento e inadimplência da plataforma.</p>
          </div>
        </div>
